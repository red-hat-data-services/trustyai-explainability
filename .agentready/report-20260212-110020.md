...
**Path**: `/Users/ddahlem/Documents/repos/trusty/red-hat-data-services/trustyai-explainability`
**Branch**: `main` | **Commit**: `81e8f5de`
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/trivy-scan.yaml, .github/workflows/CI.yaml, .github/workflows/trigger-pnc-build.yaml, .github/workflows/test.yaml
...
- **Repository Snapshot**: 81e8f5de686d3a2b858fd3755bba49518c8b1cc9
- **Assessment Duration**: 0.8s
